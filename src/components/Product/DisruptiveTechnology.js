...
import { DisruptiveTechnologyQuestions } from '../../fake-data/productQuestionsData';
import SharedAutoComplete from '../../shared-components/SharedAutoComplete';

const initialData = { TD_1: '' };

const DisruptiveTechnology = () => {
      ...
      <form className="flex flex-col space-y-16">
        ...
        <div className="w-full flex flex-col items-center space-y-12 my-8">
          ...
          <div className="w-full flex flex-wrap">
            {DisruptiveTechnologyQuestions.map((question) => (
              <div
...
export default DisruptiveTechnology;
