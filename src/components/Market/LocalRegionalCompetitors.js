...
import { LocalRegionalCompetitorsQuestions } from '../../fake-data/marketQuestionsData';
import SharedAutoComplete from '../../shared-components/SharedAutoComplete';

const initialData = { COMP_1: '' };

const LocalRegionalCompetitors = () => {
      ...
      <form className="flex flex-col space-y-16">
        ...
        <div className="w-full flex flex-col items-center space-y-12 my-8">
          ...
          <div className="w-full flex flex-wrap">
            {LocalRegionalCompetitorsQuestions.map((question) => (
              <div
...
export default LocalRegionalCompetitors;
